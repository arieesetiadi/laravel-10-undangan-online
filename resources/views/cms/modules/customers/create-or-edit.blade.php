                    ...
                    <div class="card-body">
                        <form id="customer-{{ $edit ? 'edit' : 'create' }}" action="{{ $edit ? route('cms.customers.update', $customer->id) : route('cms.customers.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control number-input" id="phone" name="phone" type="text" value="{{ old('phone', $customer->phone ?? null) }}" aria-describedby="label-phone" placeholder="e.g. 0821xxxxxxxx">
                                @error('phone')
