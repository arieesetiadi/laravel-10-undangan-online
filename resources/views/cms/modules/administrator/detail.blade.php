                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="m-b-md">
                                ...
                                <input name="username" type="text" class="form-control" id="username" aria-describedby="username" placeholder="e.g. robert" value="{{ $administrator->username }}" disabled aria-disabled="true">
                            </div>

                            <div class="m-b-md">
                                <label for="name" class="form-label d-block">Name</label>
                                <input name="name" type="text" class="form-control" id="name" aria-describedby="name" placeholder="e.g. Robert Emerson" value="{{ $administrator->name }}" disabled aria-disabled="true">
                            </div>

                            <div class="m-b-md">
                                <label for="email" class="form-label d-block">Email</label>
                                <input name="email" type="email" class="form-control" id="email" aria-describedby="email" placeholder="e.g. email@example.com" value="{{ $administrator->email }}" disabled aria-disabled="true">
                            </div>

                            <div class="m-b-md">
                                <label for="created-at" class="form-label d-block">Created At</label>
                                <input name="created_at" type="text" class="form-control" id="created-at" aria-describedby="created_at" value="{{ human_datetime($administrator->created_at) }}" disabled aria-disabled="true">
                            </div>
