                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-start gap-2">
                        ...
                        <a href="{{ route('cms.administrator.pdf') }}" target="_blank" class="btn btn-sm btn-light">Export
                            PDF</a>
                        <a href="{{ route('cms.administrator.excel') }}" target="_blank" class="btn btn-sm btn-light">Export
                            Excel</a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <img src="{{ $administrator->avatar_path }}"
                                             alt="{{ $administrator->name . ' profile image.' }}" width="25px"
                                             height="25px" class="rounded-circle cursor-pointer" data-bs-toggle="modal"
