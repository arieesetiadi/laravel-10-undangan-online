            ...
            <div class="card">
                <div class="card-body">
                    <form id="faq-{{ $edit ? 'edit' : 'create' }}" action="{{ $edit ? route('cms.faqs.update', $faq->id) : route('cms.faqs.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- Input Question --}}
                        <div class="mb-4">
                            <label class="form-label d-block" id="label-question" for="question">
                                Pertanyaan <span class="text-danger">*</span>
                            </label>
                            <input class="form-control" id="question" name="question" type="text" value="{{ old('question', $faq->question ?? null) }}" aria-describedby="label-question"
                        ...
                        {{-- Input Answer --}}
                        <div class="mb-4">
                            <label class="form-label d-block" id="label-answer" for="answer">
                                Jawaban <span class="text-danger">*</span>
                            </label>
                            <textarea class="form-control" id="answer" name="answer" type="text" aria-describedby="label-answer" placeholder="e.g. Cara melakukan pemesanan adalah.."
                                rows="4">{{ old('answer', $faq->answer ?? null) }}</textarea>
                            @error('answer')
