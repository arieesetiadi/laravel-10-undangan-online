                ...
                <div class="card-body">
                    <form class="row" id="variant-{{ $edit ? 'edit' : 'create' }}" action="{{ $edit ? route('cms.variants.update', $variant->id) : route('cms.variants.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 col-12 col-lg-6">
                            ...
                            <select id="discount-type" name="discount_type" class="form-select" aria-label="Allow Discount Type" aria-describedby="label-discount-type">
                                <option selected hidden>Pilih Jenis Diskon</option>
                        ...
                        <div class="mb-4 col-12 col-lg-6">
                            ...
                            <input class="form-control number-input" id="discount-amount" name="discount_amount" type="text" value="{{ old('discount_amount', $variant->discount_amount ?? null) }}" aria-describedby="label-discount_amount" placeholder="e.g. 50000">
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-galleries" name="allow_galleries" class="form-select" aria-label="Allow galleries" aria-describedby="label-allow-galleries">
                                <option selected hidden>Berisi Galeri?</option>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <input class="form-control number-input" id="max-galleries" name="max_galleries" type="text" value="{{ old('max_galleries', $variant->max_galleries ?? null) }}" aria-describedby="label-max-galleries"
                                placeholder="e.g. 15">
                            @error('max_galleries')
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-videos" name="allow_videos" class="form-select" aria-label="Allow videos" aria-describedby="label-allow-videos">
                                <option selected hidden>Berisi Video?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <input class="form-control number-input" id="max-videos" name="max_videos" type="text" value="{{ old('max_videos', $variant->max_videos ?? null) }}" aria-describedby="label-max-videos" placeholder="e.g. 2">
                            @error('max_videos')
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-couple-photos" name="allow_couple_photos" class="form-select" aria-label="Allow couple photos" aria-describedby="label-allow-couple-photos">
                                <option selected hidden>Berisi Foto Pasangan?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-google-maps" name="allow_google_maps" class="form-select" aria-label="Allow Google Maps" aria-describedby="label-allow-google-maps">
                                <option selected hidden>Berisi Google Maps?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-countdown" name="allow_countdown" class="form-select" aria-label="Allow Countdown" aria-describedby="label-allow-countdown">
                                <option selected hidden>Berisi Countdown?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-backsound" name="allow_backsound" class="form-select" aria-label="Allow Backsound" aria-describedby="label-allow-backsound">
                                <option selected hidden>Berisi Musik Latar?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-guest-book" name="allow_guest_book" class="form-select" aria-label="Allow Guest Book" aria-describedby="label-allow-guest-book">
                                <option selected hidden>Berisi Buku Tamu?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-guest-target" name="allow_guest_target" class="form-select" aria-label="Allow Guest Target" aria-describedby="label-allow-guest-target">
                                <option selected hidden>Berisi Nama Tamu?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-rsvp" name="allow_rsvp" class="form-select" aria-label="Allow RSVP" aria-describedby="label-allow-rsvp">
                                <option selected hidden>Berisi RSVP?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
                        ...
                        <div class="mb-4 col-6 col-lg-3">
                            ...
                            <select id="allow-rsvp" name="allow_rsvp" class="form-select" aria-label="Allow Gift" aria-describedby="label-allow-rsvp">
                                <option selected hidden>Berisi Gift?</option>
                                <option value="1">Iya</option>
                                <option value="0">Tidak</option>
                            </select>
