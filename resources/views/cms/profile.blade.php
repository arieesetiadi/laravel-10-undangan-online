                        ...
                        <div class="col-12 col-md-7 col-lg-7">
                            <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link {{ !$errors->any() ? 'active' : '' }}" id="pills-view-mode"
                                        data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab"
                                        aria-controls="pills-home" aria-selected="true">View Mode</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link {{ $errors->any() ? 'active' : '' }}" id="pills-edit-mode"
                                        data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab"
                                        aria-controls="pills-profile" aria-selected="false">Edit Mode</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                {{-- View Mode --}}
                                <div class="tab-pane fade {{ !$errors->any() ? 'show active' : '' }}" id="pills-home"
                                    role="tabpanel" aria-labelledby="pills-view-mode">
                                    <form>
                                        <div class="auth-credentials m-b-xxl">
                                            <div class="m-b-md">
                                                <label for="username" class="form-label d-block">Username</label>
                                                <input name="username" type="text" class="form-control" id="username"
                                                    aria-describedby="username" value="{{ administrator()->username }}"
                                            ...
                                            <div class="m-b-md">
                                                ...
                                                <input name="name" type="text" class="form-control" id="name"
                                                    aria-describedby="name" value="{{ administrator()->name }}" disabled
                                                    aria-disabled="true">
                                            </div>
                                            ...
                                            <div class="m-b-md">
                                                ...
                                                <input name="email" type="email" class="form-control" id="email"
                                                    aria-describedby="email" value="{{ administrator()->email }}" disabled
                                                    aria-disabled="true">
                                            </div>

                                            <div class="m-b-md">
                                                <label for="created_at" class="form-label d-block">Created At</label>
                                                <input name="created_at" type="text" class="form-control" id="created_at"
                                                    aria-describedby="created_at"
                                                    value="{{ human_datetime(administrator()->created_at) }}"
                                                    disabled aria-disabled="true">
                                            </div>
                                        </div>
                                    </form>
                                ...
                                {{-- Edit Mode --}}
                                <div class="tab-pane fade {{ $errors->any() ? 'show active' : '' }}" id="pills-profile"
                                    role="tabpanel" aria-labelledby="pills-edit-mode">
                                        ...
                                        <div class="auth-credentials m-b-xxl">
                                            <div class="m-b-md">
                                                ...
                                                <input name="username" type="text" class="form-control" id="username"
                                                    ...
                                                    value="{{ old('username', administrator()->username) }}">
                                                @error('username')
                                            ...
                                            <div class="m-b-md">
                                                <label for="name" class="form-label d-block">Name</label>
                                                <input name="name" type="text" class="form-control" id="name"
                                                    aria-describedby="name" placeholder="e.g. Robert"
                                            ...
                                            <div class="m-b-md">
                                                <label for="email" class="form-label d-block">Email</label>
                                                <input name="email" type="email" class="form-control" id="email"
                                                    aria-describedby="email" placeholder="e.g. Robert"
